...
export const PageHeader = ({ title }: { title: string }) => {
    return (
        <div className="sticky z-20 bg-background p-3 top-0 flex-col-reverse gap-4 flex md:flex-row items-center justify-between">
            ...
            <h1 className="text-primary flex gap-3 text-4xl font-extrabold"><p className="text-white">TOP</p>{title}</h1>
        </div>
    )
}