...
export const ClientMenu = ({ images, userUI }: { images: string[], userUI: React.ReactNode }) => {
    ...
    return (
        <div className={`w-full h-full xl:pt-6 xl:pl-2 top-0 transition-all duration-200 ease-in ${menuOpen ? "backdrop-blur-sm" : null} xl:h-fit justify-end items-between flex flex-col gap-2 overflow-hidden xl:max-w-[400px]`}>
